...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    name_list = sorted(people_list, key=lambda x: x.full_name)
    new_list = sorted(name_list, key=lambda x: len(x.hobbies), reverse=True)
    return new_list
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    """
    name_list = sorted(people_list, key=lambda x: x.full_name)
    new_list = sorted(name_list, key=lambda x: len(x.hobbies))
    return new_list
