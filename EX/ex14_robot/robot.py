...
def follow_the_line(robot: FollowerBot):
    ...
    while True:
        ...
        if sensor_3 < 200 and sensor_2 < 200:
            while True:
                ...
                if new_sensor_5 >= 700 or new_sensor_2 >= 700:
                    break
        elif sensor_2 >= 700 and (sensor_4 < 200 or sensor_5 < 200 or sensor_6 < 200):
            while True:
                ...
                if new_sensor_5 >= 700:
                    break
        elif sensor_5 >= 700 and (sensor_3 < 200 or sensor_2 < 200 or sensor_1 < 2001):
            while True:
